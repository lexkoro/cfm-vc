...
class ResidualBlock(torch.nn.Module):
    ...
    def __init__(
        ...
        self.conv_out = Conv1d1x1(gate_out_channels, residual_channels, bias=bias)
        self.conv_skip = Conv1d1x1(gate_out_channels, skip_channels, bias=bias)
