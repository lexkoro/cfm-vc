...
class ResNetSpeakerEncoder(nn.Module):
    ...
    def get_torch_mel_spectrogram_class(self):
    ...
    def compute_embedding(self, wav_file: str):
        """Computes the embedding for a given wav file
        ...
        speech = audio.unsqueeze(0).to(self.conv1.weight.device)
        embeddings = self(speech)
        return embeddings
